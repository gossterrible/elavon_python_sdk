...
class DeleteDocumentPacketResponse(object):

    """Implementation of the 'DeleteDocumentPacketResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DeleteDocumentPacketResponse class"""
