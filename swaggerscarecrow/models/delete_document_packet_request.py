...
class DeleteDocumentPacketRequest(object):

    """Implementation of the 'DeleteDocumentPacketRequest' model.

    TODO: type model description here.

    Attributes:
        document_packet_id (string): The unique identifier for document
            packet
    ...
    def __init__(self,
        ...
        """Constructor for the DeleteDocumentPacketRequest class"""
