...
class UpdateDocumentPacketResponse(object):

    """Implementation of the 'UpdateDocumentPacketResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the UpdateDocumentPacketResponse class"""
