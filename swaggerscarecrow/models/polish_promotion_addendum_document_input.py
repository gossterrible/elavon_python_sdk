...
class PolishPromotionAddendumDocumentInput(object):

    """Implementation of the 'PolishPromotionAddendumDocumentInput' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PolishPromotionAddendumDocumentInput class"""
