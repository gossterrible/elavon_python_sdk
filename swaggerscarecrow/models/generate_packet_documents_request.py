...
class GeneratePacketDocumentsRequest(object):

    """Implementation of the 'GeneratePacketDocumentsRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the GeneratePacketDocumentsRequest class"""
