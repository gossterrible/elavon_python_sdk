...
class DeleteGroupDocumentPacketResponse(object):

    """Implementation of the 'DeleteGroupDocumentPacketResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DeleteGroupDocumentPacketResponse class"""
