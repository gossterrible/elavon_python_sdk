...
class ElavonPciServiceDocumentInput(object):

    """Implementation of the 'ElavonPciServiceDocumentInput' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ElavonPciServiceDocumentInput class"""
