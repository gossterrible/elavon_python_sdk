...
class CreateDocumentPacketResponse(object):

    """Implementation of the 'CreateDocumentPacketResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CreateDocumentPacketResponse class"""
