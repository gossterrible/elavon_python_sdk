...
class PersonalGuaranteeDocumentInput(object):

    """Implementation of the 'PersonalGuaranteeDocumentInput' model.
    ...
    def __init__(self,
        ...
        """Constructor for the PersonalGuaranteeDocumentInput class"""
