...
from swaggerscarecrow.models.async_context import *
...
class ServletRequest(object):

    """Implementation of the 'ServletRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the ServletRequest class"""
