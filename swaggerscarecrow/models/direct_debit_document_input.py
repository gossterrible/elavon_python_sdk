...
class DirectDebitDocumentInput(object):

    """Implementation of the 'DirectDebitDocumentInput' model.
    ...
    Attributes:
        ...
        bank_account (BankingInfo): TODO: type description here.
        bank_account_detail (BankAccountAdditionalInfo): TODO: type
            description here.
    ...
    def __init__(self,
        ...
        """Constructor for the DirectDebitDocumentInput class"""
    ...
    def from_dictionary(cls,
        ...
        bank_account = BankingInfo.from_dictionary(dictionary.get('bankAccount')) if dictionary.get('bankAccount') else None
        bank_account_detail = BankAccountAdditionalInfo.from_dictionary(dictionary.get('bankAccountDetail')) if dictionary.get('bankAccountDetail') else None
