...
class ElavonPaymentGatewayAddendumDocumentInput(object):

    """Implementation of the 'ElavonPaymentGatewayAddendumDocumentInput' model.
    ...
    Attributes:
        ...
        fees (list of Fee): Application's fees
    ...
    def __init__(self,
        ...
        """Constructor for the ElavonPaymentGatewayAddendumDocumentInput class"""
