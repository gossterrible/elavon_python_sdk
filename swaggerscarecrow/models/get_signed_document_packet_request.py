...
class GetSignedDocumentPacketRequest(object):

    """Implementation of the 'GetSignedDocumentPacketRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the GetSignedDocumentPacketRequest class"""
