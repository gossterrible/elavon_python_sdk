...
| `bankingInfo` | [`BankingInfo`](../../doc/models/banking-info.md) | Required | - | getBankingInfo(): BankingInfo | setBankingInfo(BankingInfo bankingInfo): void |
| `bankAccountAdditionalInfo` | [`BankAccountAdditionalInfo`](../../doc/models/bank-account-additional-info.md) | Required | - | getBankAccountAdditionalInfo(): BankAccountAdditionalInfo | setBankAccountAdditionalInfo(BankAccountAdditionalInfo bankAccountAdditionalInfo): void |
| `additionalLeaseInfo` | [`AdditionalLeaseInfo`](../../doc/models/additional-lease-info.md) | Required | - | getAdditionalLeaseInfo(): AdditionalLeaseInfo | setAdditionalLeaseInfo(AdditionalLeaseInfo additionalLeaseInfo): void |
