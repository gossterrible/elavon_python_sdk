...
class EnrollmentInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, discount_rate, discount_amount, *args, **kwargs):  # noqa: E501
        """EnrollmentInfo - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, discount_rate, discount_amount, *args, **kwargs):  # noqa: E501
        """EnrollmentInfo - a model defined in OpenAPI
