...
class EframeRequestParams(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, unique_id, boarding_id, scarecrow_application, *args, **kwargs):  # noqa: E501
        """EframeRequestParams - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, unique_id, boarding_id, scarecrow_application, *args, **kwargs):  # noqa: E501
        """EframeRequestParams - a model defined in OpenAPI
