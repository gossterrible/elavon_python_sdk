...
class BoardingStatusRequestParams(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, client_id, unique_id, country, sales_rep_code, *args, **kwargs):  # noqa: E501
        """BoardingStatusRequestParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            boarding_id (str): MID(EU)/AWB(NA), value is returned from a successful boarding. [optional]  # noqa: E501
            correlation_id (str): [NA] Identifier of alternative correlation Id to be used in the place of boardingId. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, client_id, unique_id, country, sales_rep_code, *args, **kwargs):  # noqa: E501
        """BoardingStatusRequestParams - a model defined in OpenAPI
