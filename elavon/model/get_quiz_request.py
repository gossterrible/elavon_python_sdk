...
class GetQuizRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, principal, business_address, language, *args, **kwargs):  # noqa: E501
        """GetQuizRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, principal, business_address, language, *args, **kwargs):  # noqa: E501
        """GetQuizRequest - a model defined in OpenAPI
