...
class ApmPricingTier(ModelNormal):
    ...
    attribute_map = {
        'combining_code': 'combiningCode',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, combining_code, per_item_amount, rate_percentage, description, *args, **kwargs):  # noqa: E501
        """ApmPricingTier - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, combining_code, per_item_amount, rate_percentage, description, *args, **kwargs):  # noqa: E501
        """ApmPricingTier - a model defined in OpenAPI
