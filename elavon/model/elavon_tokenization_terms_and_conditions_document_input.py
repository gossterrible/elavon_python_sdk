...
class ElavonTokenizationTermsAndConditionsDocumentInput(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, language, document_id, principal, business_info, *args, **kwargs):  # noqa: E501
        """ElavonTokenizationTermsAndConditionsDocumentInput - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, language, document_id, principal, business_info, *args, **kwargs):  # noqa: E501
        """ElavonTokenizationTermsAndConditionsDocumentInput - a model defined in OpenAPI
