...
class DirectDebitDocumentInput(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'bank_account': (BankingInfo,),  # noqa: E501
            'bank_account_detail': (BankAccountAdditionalInfo,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'bank_account_detail': 'bankAccountDetail',  # noqa: E501
        'business_info': 'businessInfo',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, language, document_id, principal, bank_account, bank_account_detail, business_info, *args, **kwargs):  # noqa: E501
        """DirectDebitDocumentInput - a model defined in OpenAPI

        Args:
            language (str): Language of document to be generated,  ISO 639-1 standard applies
            document_id (str): Unique id of document
            principal (Person):
            bank_account (BankingInfo):
            bank_account_detail (BankAccountAdditionalInfo):
    ...
    @convert_js_args_to_python_args
    def __init__(self, language, document_id, principal, bank_account, bank_account_detail, business_info, *args, **kwargs):  # noqa: E501
        """DirectDebitDocumentInput - a model defined in OpenAPI
