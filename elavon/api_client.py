...
from elavon import rest
from elavon.configuration import Configuration
from elavon.exceptions import ApiTypeError, ApiValueError, ApiException
from elavon.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = SATIDAPIApi()
        api_instance.answer_quiz  # this is an instance of the class Endpoint
        api_instance.answer_quiz()  # this invokes api_instance.answer_quiz.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.answer_quiz.callable or self.callable in this class
