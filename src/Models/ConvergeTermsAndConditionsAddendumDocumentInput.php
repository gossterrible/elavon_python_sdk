...
class ConvergeTermsAndConditionsAddendumDocumentInput implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(string $language, string $documentId, EquipmentInfo $equipmentInfo)
    {
