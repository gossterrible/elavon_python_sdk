...
class ElavonTokenizationTermsAndConditionsDocumentInput implements \JsonSerializable
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(string $language, string $documentId, Person $principal, BusinessInfo $businessInfo)
    {
