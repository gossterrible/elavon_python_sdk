...
namespace SwaggerScarecrowLib\Exceptions;
...
class ApiException extends \Exception implements Exception
{
     ...
     * HTTP request
     *
     * @var \SwaggerScarecrowLib\Http\HttpRequest
     */
    private $request;
     ...
     * HTTP response
     *
     * @var \SwaggerScarecrowLib\Http\HttpResponse|null
     */
    private $response;

    /**
     * @param string $reason the reason for raising an exception
     * @param \SwaggerScarecrowLib\Http\HttpRequest $request
     */
