...
use SwaggerScarecrowLib\Controllers;

/**
 * SwaggerScarecrowLib client class
 */
class SwaggerScarecrowClient implements ConfigurationInterface
{
    private $sATIDAPI;
    ...
    /**
     * Returns SATIDAPI Controller
     */
    public function getSATIDAPIController(): Controllers\SATIDAPIController
    {
        if ($this->sATIDAPI == null) {
            $this->sATIDAPI = new Controllers\SATIDAPIController(
                $this,
                $this->authManagers,
                $this->httpCallback
            );
        }
        return $this->sATIDAPI;
    }
